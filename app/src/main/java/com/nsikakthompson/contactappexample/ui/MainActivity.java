...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Setup Viewmodel instance*/
        mainAcivityViewmodel = ViewModelProviders.of(this, new AppFactory(appController)).get(MainAcivityViewmodel.class);
        ...
        contactAdapter = new RecyclerAdapter(this,new ArrayList<>());
        recyclerView.setAdapter(contactAdapter);

        mainAcivityViewmodel.getContact().observe(this, contacts ->{
